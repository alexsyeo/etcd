...
PRT_EVENTDECL* P_Available_DOS_INNER[] = { &P_EVENT_AddServer, &P_EVENT_AddServerResponse, &P_EVENT_NotifyLeaderUpdate, &P_EVENT_RedirectRequest, &P_EVENT_RemoveServer, &P_EVENT_RemoveServerResponse, &P_EVENT_Request, &P_EVENT_Response, &P_EVENT_SentAllTicks, &P_EVENT_ShutDown };
...
PRT_VALUE* P_Tick_IMPL(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* PTMP_tmp9_24 = NULL;
    
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE P_LIT_INT32_78 = { PRT_VALUE_KIND_INT, { .nt = 0 } };
    PRT_VALUE P_LIT_INT32_79 = { PRT_VALUE_KIND_INT, { .nt = 1 } };
    PRT_VALUE P_LIT_BOOLEAN_37 = { PRT_VALUE_KIND_BOOL, { .bl = PRT_TRUE } };
    PRT_VALUE** P_LVALUE_1401 = &(P_VAR_i_4);
    PrtFreeValue(*P_LVALUE_1401);
    *P_LVALUE_1401 = PrtCloneValue((&P_LIT_INT32_78));
    
    PRT_VALUE** P_LVALUE_1402 = &(PTMP_tmp0_84);
    PrtFreeValue(*P_LVALUE_1402);
    *P_LVALUE_1402 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[0]));
    
    PrtFormatPrintf("Size of Servers: ", 1, PTMP_tmp0_84, 1, 0, "");
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_37)))
    {
        PRT_VALUE** P_LVALUE_1403 = &(PTMP_tmp1_72);
        PrtFreeValue(*P_LVALUE_1403);
        *P_LVALUE_1403 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[0]));
        
        PRT_VALUE** P_LVALUE_1404 = &(PTMP_tmp2_63);
        PrtFreeValue(*P_LVALUE_1404);
        *P_LVALUE_1404 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_4) < PrtPrimGetInt(PTMP_tmp1_72));
        
        PRT_VALUE** P_LVALUE_1405 = &(PTMP_tmp3_58);
        PrtFreeValue(*P_LVALUE_1405);
        *P_LVALUE_1405 = PrtCloneValue(PTMP_tmp2_63);
        
        if (PrtPrimGetBool(PTMP_tmp3_58))
        {
        }
        ...
        PRT_VALUE** P_LVALUE_1406 = &(PTMP_tmp4_50);
        PrtFreeValue(*P_LVALUE_1406);
        *P_LVALUE_1406 = PrtSeqGet(p_this->varValues[0], P_VAR_i_4);
        
        PRT_VALUE** P_LVALUE_1407 = &(PTMP_tmp5_39);
        PrtFreeValue(*P_LVALUE_1407);
        *P_LVALUE_1407 = PrtCloneValue(PTMP_tmp4_50);
        
        PRT_VALUE** P_LVALUE_1408 = &(PTMP_tmp6_37);
        PrtFreeValue(*P_LVALUE_1408);
        *P_LVALUE_1408 = PrtCloneValue((&P_EVENT_TickEvent.value));
        
        PrtSendInternal(context, PrtGetMachine(context->process, PTMP_tmp5_39), PTMP_tmp6_37, 0);
        *(&(PTMP_tmp6_37)) = NULL;
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_92;
        }
        ...
        *P_LVALUE_1409 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_4) + PrtPrimGetInt((&P_LIT_INT32_79)));
        
        {
            PRT_VALUE** P_LVALUE_1410 = &(P_VAR_i_4);
            PrtFreeValue(*P_LVALUE_1410);
            *P_LVALUE_1410 = PTMP_tmp7_30;
            PTMP_tmp7_30 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_1411 = &(PTMP_tmp8_27);
    PrtFreeValue(*P_LVALUE_1411);
    *P_LVALUE_1411 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_1412 = &(PTMP_tmp9_24);
    PrtFreeValue(*P_LVALUE_1412);
    *P_LVALUE_1412 = PrtCloneValue((&P_EVENT_SentAllTicks.value));
    
    PrtSendInternal(context, PrtGetMachine(context->process, PTMP_tmp8_27), PTMP_tmp9_24, 0);
    *(&(PTMP_tmp9_24)) = NULL;
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_92;
    }
...
p_return_92: ;
    ...
    PrtFreeValue(PTMP_tmp9_24); PTMP_tmp9_24 = NULL;
    return _P_GEN_retval;
}
